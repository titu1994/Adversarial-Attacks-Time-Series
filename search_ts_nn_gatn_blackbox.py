...
from models.timeseries import gatn, base, classical_distilled
...
if __name__ == '__main__':
    ...
    log_path = 'logs/'
    log_name = 'gatn_nn_student_teacher_blackbox_results.csv'
    ...
    for dataset_id in datasets:
        for beta in BETAS:
            ...
            atn_model_name = 'gridsearch-nn-student-teacher-blackbox-' + atn_model_fn.__name__
            student_model_name = 'gridsearch-nn-student-teacher-blackbox-' + student_model_fn.__name__
